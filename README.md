...
```bash
curl -s https://raw.githubusercontent.com/tranviettrung/docker-magento/master/lib/onelinesetup | bash -s -- magento.test 2.4.2
```
...
curl -s https://raw.githubusercontent.com/tranviettrung/docker-magento/master/lib/template | bash
